...
CastPlayer.prototype.initializeCastPlayer = function() {
    ...
    // use the window.chrome.cast.media.DEFAULT_MEDIA_RECEIVER_APP_ID
    options.receiverApplicationId = '879D4DC9';
    ...
    let credentialsData = new window.chrome.cast.CredentialsData("{\"userId\": \"abc\"}");
    window.cast.framework.CastContext.getInstance().setLaunchCredentialsData(credentialsData);
...
/**
 * Makes human-readable message from window.chrome.cast.Error
 * @param {window.chrome.cast.Error} error
